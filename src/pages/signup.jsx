import { IconSelectProfile, IconSignupProfile } from "@/assets/Icons";
    ...
    <>
      ...
      <main className="px-6 pt-12 flex flex-col gap-14 items-center ">
        <div className="relative w-full flex flex-col items-center gap-4">
          ...
          <button
            onClick={() => (level > 0 ? setLevel(level - 1) : router.push("/"))}
          ...
          <button
            ...
            className="bg-primary-900 rounded-full text-white w-8 h-8 flex items-center justify-center text-xl absolute right-0 top-0"
          >
            <MdCheck />
          </button>
        </div>
        {level === 0 ? (
          <form className="flex flex-col items-center gap-8">
            <div className="w-full flex flex-col items-center gap-3 ">
              ...
              <p className="text-xs">
                In order to complete registration process, A code will be send
                you
              </p>
            </div>
          </form>
          ...
          <form className="flex flex-col items-start gap-6">
            <span className="text-[10px]">Please enter the code </span>
          ...
          <div>
            <div className="flex flex-col items-center gap-3">
              <div className="w-28 h-28 rounded-full bg-primary-50 relative flex items-center justify-center">
                <Image alt="selectProfile" src={IconSelectProfile} />
              </div>
              <span className="text-xs">Please Choose a Avatar</span>
            </div>
          </div>
        ) : (
